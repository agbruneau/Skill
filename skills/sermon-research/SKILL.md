...
description: Deep research assistant for weekly sermon preparation. Provide a scripture passage, topic, and questions -- get back commentary insights, historical context, original language notes, and thinking prompts. Research only -- no outlines, no sermon writing. Default lens surveys commentators broadly; if the pastor asks for research framed solely by John MacArthur (gty.org, MacArthur NT Commentary, MacArthur Study Bible, Biblical Doctrine, Master's Seminary), follow macarthur/MACARTHUR.md instead of the default workflow.
---
...
The default lens is broad: commentators from several evangelical traditions are surveyed and genuine disagreements are reported, not resolved (see Step 4). If the pastor asks for the research framed **solely by John MacArthur's exposition** (MacArthur, gty.org / Grace to You, Master's Seminary), stop here and follow [macarthur/MACARTHUR.md](macarthur/MACARTHUR.md) instead — it overrides the sources, the theological frame, the output language (Canadian French), and the PDF generator.
