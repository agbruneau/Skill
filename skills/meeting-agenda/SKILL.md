---
name: meeting-agenda
description: Build a structured CHURCH meeting agenda — time blocks, Update/Discussion/Decision tags, decisions scheduled early, prayer to open and close. For church staff meetings, elder/deacon boards, volunteer huddles, committees, and pastoral one-on-ones. Use when a pastor or church leader asks for a meeting agenda (read pastor-foundation first). Do NOT use for secular business meetings (sprint planning, standups, client calls) — the output includes prayer and church formatting by design.
---
